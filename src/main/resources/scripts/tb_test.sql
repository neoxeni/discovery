...
INSERT INTO cmm_code (div_cd, parent_cd, cd, cd_nm, sort_no, dtl, use_yn, created_by, created_at, updated_by, updated_at, etc1, etc2, etc3, etc4, client_id) VALUES ('OR01', 'ROOT', 'OR01AB', '대표이사', 1, null, 'Y', 1, now(), 1, now(), null, null, null, null, 1);
INSERT INTO cmm_code (div_cd, parent_cd, cd, cd_nm, sort_no, dtl, use_yn, created_by, created_at, updated_by, updated_at, etc1, etc2, etc3, etc4, client_id) VALUES ('OR01', 'ROOT', 'OR01AC', '팀장', 2, null, 'Y', 1, now(), 1, now(), null, null, null, null, 1);
INSERT INTO cmm_code (div_cd, parent_cd, cd, cd_nm, sort_no, dtl, use_yn, created_by, created_at, updated_by, updated_at, etc1, etc2, etc3, etc4, client_id) VALUES ('OR02', 'ROOT', 'OR02AB', '사장', 1, null, 'Y', 1, now(), 1, now(), null, null, null, null, 1);
INSERT INTO cmm_code (div_cd, parent_cd, cd, cd_nm, sort_no, dtl, use_yn, created_by, created_at, updated_by, updated_at, etc1, etc2, etc3, etc4, client_id) VALUES ('OR02', 'ROOT', 'OR02AC', '이사', 2, null, 'Y', 1, now(), 1, now(), null, null, null, null, 1);
